...
(function($){$.fn.extend({bxGallery:function(options){var defaults={maxwidth:'',maxheight:'',thumbwidth:200,thumbcrop:false,croppercent:.35,thumbplacement:'bottom',thumbcontainer:'',opacity:.7,load_text:'',load_image:'./newbuild/loaderWhite.gif',wrapperclass:'outer'}
...
$outer.append('');if(o.thumbcontainer!=''){$outer.find('.thumbs').width(o.thumbcontainer);}}
